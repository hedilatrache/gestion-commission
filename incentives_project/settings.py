"""
Django settings for incentives_project project.
...
# ⚡ Authentification
# -----------------------
AUTH_USER_MODEL = 'commissions.Utilisateur' # Utilisateur personnalisé
LOGIN_URL = '/login/'                        # Redirection si pas connecté
LOGIN_REDIRECT_URL = '/utilisateurs/'        # Après login
